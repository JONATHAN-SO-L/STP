...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/stp/soledad/css/ml_botones.css">
</head>
...
<?php
  ...
  $row=mysqli_fetch_row($resultado);
    ...
    <button name="reiniciar" style="margin: 10px" type="sumbit" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#miModal3"><img id="ren" src="/stp/soledad/img/reiniciar.png">REINICIAR META DE LIBROS</button>
    </div>';
...
<div id="form_ml" class="container">
  ...
  <form class="form-inline">
    <img id="ml-index" src="/stp/soledad/img/ml.png" style="margin-top: 10px" ><h2 class="form-title" style="margin: 10px">FORMULARIO DE INICIO DE LECTURA DE LIBROS DE LA ORGANIZACIÓN</h2>
  </form>
  </div>
...
<div id="form_ml" class="container">
  ...
  <div class="container">
  <form class="form-inline">
    <img id="ml-index" src="/stp/soledad/img/ml.png" style="margin-top: 10px" ><h2 class="form-title" style="margin: 10px">FORMULARIO DE MODIFICACIÓN DE LA LECTURA DE LIBROS DE LA ORGANIZACIÓN</h2>
  </form>
  </div>
...
<br>
    <div class="form-group">
      <a href="/stp/soledad/sistema/ml/reinicio.php"><input type="submit" class="btn btn-danger" id="eliminar" name="eliminar" value="SI, REINICIALO"></a>
    </div><br>
</div>
</div>
</div>
