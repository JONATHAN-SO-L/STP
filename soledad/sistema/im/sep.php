...
<?php
  ...
  include "../../funciones/conexion.php";
    ...
    $resultado = mysqli_query($conexion,"SELECT EXISTS (SELECT * FROM septiembre_s);");
    $row=mysqli_fetch_row($resultado);

      if ($row[0]=="1") {

        $resultado = mysqli_query($conexion, "SELECT * FROM septiembre_s");

      while ($septiembre = mysqli_fetch_array($resultado)) {
          ...
          <div class='container'>
            <table class='table table-dark table-hover'>
                <tr>
                  ...
                  <td><center><strong>".$septiembre['publicaciones']."</strong></center></td>
                </tr>
                <tr>
                  <td><center>VIDEOS</center></td>
                  <td><center><strong>".$septiembre['videos']."</strong></center></td>
                </tr>
                <tr>
                  <td><center>HORAS</center></td>
                  <td><center><strong>".$septiembre['horas']."</strong></center></td>
                </tr>
                <tr>
                  <td><center>REVISITAS</center></td>
                  <td><center><strong>".$septiembre['revisitas']."</strong></center></td>
                </tr>
                <tr>
                  <td><center>NÚMERO DE <i> DIFERENTES </i><br> CURSOS BÍBLICOS DIRIGIDOS</center></td>
                  <td><center><strong>".$septiembre['cursos']."</strong></center></td>
                </tr>
                <tr>
                  <td><center>COMENTARIOS</center></td>
                  <td><center><strong>".$septiembre['comentarios']."</strong></center></td>
                </tr>
            </table>
            <div class='form-group'>
              <center>
              <a href='/stp/soledad/sistema/im/mod9.php' class='btn active btn-warning' style='color:white;'>MODIFICAR INFORME</a>
              </center>
            </div>
          </div>
...
echo '  <div class="container">
    <form class="form-inline" id="informe" method="POST" action="#"><br>
      <h3 class="titulo_informe"><center><strong>INFORME DE SEPTIEMBRE</strong></center></h3><br>
...
<br>';
  ...
  if (isset($_POST['guardar'])) {
    ...
    $conexion->query("INSERT INTO septiembre_s (publicaciones, videos, horas, revisitas, cursos, comentarios) VALUES ('$pubs', '$videos', '$hours', '$revisit', '$courses', '$comments')");
