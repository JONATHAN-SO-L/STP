...
<?php
  ...
  if (isset($_POST['guardar'])) {
    ...
    $conexion->query("UPDATE julio_s SET publicaciones='$pubs', videos='$videos', horas='$hours', revisitas='$revisit', cursos='$courses', comentarios='$comments'");
    ...
    <form class="form-inline" id="informe" method="POST" action="#"><br>
      <h3 class="titulo_informe"><center><strong>INFORME DE JULIO</strong></center></h3><br>
          ...
          <div class="form-inline">
            ...
            <input style="margin: 5px;" required="#" type="number" class="form-control" id="revisitas" name="revisitas" placeholder="0">
          </div><br>
          <div class="form-inline">
