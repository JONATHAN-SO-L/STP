...
<?php
  ...
  include "../../funciones/conexion.php";
    ...
    $resultado = mysqli_query($conexion,"SELECT EXISTS (SELECT * FROM marzo_s);");
    $row=mysqli_fetch_row($resultado);

      if ($row[0]=="1") {

        $resultado = mysqli_query($conexion, "SELECT * FROM marzo_s");

      while ($marzo = mysqli_fetch_array($resultado)) {
          ...
          <div class='container'>
            <table class='table table-dark table-hover'>
                <tr>
                  ...
                  <td><center><strong>".$marzo['publicaciones']."</strong></center></td>
                </tr>
                <tr>
                  <td><center>VIDEOS</center></td>
                  <td><center><strong>".$marzo['videos']."</strong></center></td>
                </tr>
                <tr>
                  <td><center>HORAS</center></td>
                  <td><center><strong>".$marzo['horas']."</strong></center></td>
                </tr>
                <tr>
                  <td><center>REVISITAS</center></td>
                  <td><center><strong>".$marzo['revisitas']."</strong></center></td>
                </tr>
                <tr>
                  <td><center>NÚMERO DE <i> DIFERENTES </i><br> CURSOS BÍBLICOS DIRIGIDOS</center></td>
                  <td><center><strong>".$marzo['cursos']."</strong></center></td>
                </tr>
                <tr>
                  <td><center>COMENTARIOS</center></td>
                  <td><center><strong>".$marzo['comentarios']."</strong></center></td>
                </tr>
            </table>
            <div class='form-group'>
              <center>
              <a href='/stp/soledad/sistema/im/mod3.php' class='btn active btn-warning' style='color:white;'>MODIFICAR INFORME</a>
              </center>
            </div>
          </div>
    ...
    <form class="form-inline" id="informe" method="POST" action="#"><br>
      <h3 class="titulo_informe"><center><strong>INFORME DE MARZO</strong></center></h3><br>
  ...
  if (isset($_POST['guardar'])) {
    ...
    $conexion->query("INSERT INTO marzo_s (publicaciones, videos, horas, revisitas, cursos, comentarios) VALUES ('$pubs', '$videos', '$hours', '$revisit', '$courses', '$comments')");
