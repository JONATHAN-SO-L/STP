...
// Se consulta todo lo que esté registrado en la tabla del mes correspondiente
  $actividad_enero = mysqli_query($conexion,"SELECT * FROM enero_s");
...
// Se muestra lo que se almacenó en una tabla
  ...
  $actividad_febrero = mysqli_query($conexion,"SELECT * FROM febrero_s");
  ...
  $actividad_marzo = mysqli_query($conexion,"SELECT * FROM marzo_s");
  ...
  $actividad_abril = mysqli_query($conexion,"SELECT * FROM abril_s");
  ...
  $actividad_mayo = mysqli_query($conexion,"SELECT * FROM mayo_s");
  ...
  $actividad_junio = mysqli_query($conexion,"SELECT * FROM junio_s");
  ...
  $actividad_julio = mysqli_query($conexion,"SELECT * FROM julio_s");
  ...
  $actividad_agosto = mysqli_query($conexion,"SELECT * FROM agosto_s");
  ...
  $actividad_septiembre = mysqli_query($conexion,"SELECT * FROM septiembre_s");
  ...
  $actividad_octubre = mysqli_query($conexion,"SELECT * FROM octubre_s");
  ...
  $actividad_noviembre = mysqli_query($conexion,"SELECT * FROM noviembre_s");
  ...
  $actividad_aiciembre = mysqli_query($conexion,"SELECT * FROM diciembre_s");
...
<!-- Botón de descarga en PDF -->
      <div class="container" align="center">
        <a class="boton" href="/stp/soledad/informe"><button style="margin: 10px" type="sumbit" class="btn btn-danger btn-md"><img id="mes" src="/stp/soledad/img/descarga_pdf.png">DESCARGAR INFORME EN PDF</button></a>
      </div>
