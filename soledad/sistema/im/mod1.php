...
// Se almacenan los nuevos datos en variables
...
// Se actualizan los datos en la DDBB
    $conexion->query("UPDATE enero_s SET publicaciones='$pubs', videos='$videos', horas='$hours', revisitas='$revisit', cursos='$courses', comentarios='$comments'");
...
<!-- Fomrulario de modificación de informe -->
  <div class="container">
