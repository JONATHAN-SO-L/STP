...
if (isset($_SESSION['usuario'])) {
  switch ($_SESSION['usuario']) {
    ...
    $conexion->query("TRUNCATE TABLE enero_a");
    $conexion->query("TRUNCATE TABLE febrero_a");
    $conexion->query("TRUNCATE TABLE marzo_a");
    $conexion->query("TRUNCATE TABLE abril_a");
    $conexion->query("TRUNCATE TABLE mayo_a");
    $conexion->query("TRUNCATE TABLE junio_a");
    $conexion->query("TRUNCATE TABLE julio_a");
    $conexion->query("TRUNCATE TABLE agosto_a");
    $conexion->query("TRUNCATE TABLE septiembre_a");
    $conexion->query("TRUNCATE TABLE octubre_a");
    $conexion->query("TRUNCATE TABLE noviembre_a");
    $conexion->query("TRUNCATE TABLE diciembre_a");
