           ...
           <div id="form_ep" class="container">
            ...
            <div class="container">
              ...
              <form class="form-inline">
                <img id="ep-index" src="/stp/constantino/img/ep.png" style="margin-top: 10px" ><h2 class="form-title" style="margin: 10px">FORMULARIO DE INICIO DEL ESTUDIO PERSONAL</h2>
              </form>
            </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <div id="form_ep" class="container">
          ...
          <div class="container">
            <form class="form-inline">
              <img id="ep-index" src="/stp/constantino/img/ep.png" style="margin-top: 10px" ><h2 class="form-title" style="margin: 10px">FORMULARIO DE MODIFICACIÓN DEL ESTUDIO PERSONAL</h2>
            </form>
          </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <div id="form_ep" class="container">
        ...
        <div class="form-group">
          <a href="/stp/constantino/sistema/ep/reinicio.php"><input type="submit" class="btn btn-danger" id="eliminar" name="eliminar" value="SI, REINICIALO"></a>
        </div><br>
