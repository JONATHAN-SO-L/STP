...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/stp/constantino/css/ep_botones.css">
</head>
...
<body>
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    ...
    <form class="form-inline float-lg-right" id="volver"> <!-- Alineación a la derecha -->
      <a href="/stp/constantino/sistema/" class="btn btn-danger btn-sm">VOLVER</a> <!-- Enlace de clase botón -->
...
// Consulta si hay información ya registrada en la tabla del estudio personal
  $resultado = mysqli_query($conexion,"SELECT EXISTS (SELECT * FROM $table3);");
...
// Tabla que muestra lo que está almacenado en la DDBB
      ...
      <tbody>
      <tr>
      <td><center>".$aef ['dia']."</center></td>
      <td><center>".$aef ['hora']."</center></td>
      <td><center>".$aef ['am_pm']."</center></td>
      <td><center>".$aef ['titulo1']."</center></td>
      </tr>
      <tr>
      <td><center>".$aef ['dia']."</center></td>
      <td><center>".$aef ['hora']."</center></td>
      <td><center>".$aef ['am_pm']."</center></td>
      <td><center>".$aef ['titulo2']."</center></td>
      </tr>
      <tr>
      <td><center>".$aef ['dia']."</center></td>
      <td><center>".$aef ['hora']."</center></td>
      <td><center>".$aef ['am_pm']."</center></td>
      <td><center>".$aef ['titulo3']."</center></td>
      </tr>
      <tr>
      <td><center>".$aef ['dia']."</center></td>
      <td><center>".$aef ['hora']."</center></td>
      <td><center>".$aef ['am_pm']."</center></td>
      <td><center>".$aef ['titulo4']."</center></td>
      </tr>
      </tbody>
      </table>
      </div>
      ...
      <button name="reiniciar" style="margin: 10px" type="sumbit" class="btn btn-primary btn-danger btn-lg" data-toggle="modal" data-target="#miModal3"><img id="ren" src="/stp/constantino/img/reiniciar.png">REINICIAR PLAN DE ESTUDIO</button></div>';}
           ...
           <div id="form_ep" class="container">
            ...
            <div class="container">
              ...
              <form class="form-inline">
                <img id="aef-index" src="/stp/constantino/img/aef.png" style="margin-top: 10px" ><h2 class="form-title" style="margin: 10px">FORMULARIO DE INICIO DE ADORACIÓN EN FAMILIA</h2>
              </form>
            </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <div id="form_ep" class="container">
          ...
          <div class="container">
            <form class="form-inline">
              <img id="ep-index" src="/stp/constantino/img/aef.png" style="margin-top: 10px" ><h2 class="form-title" style="margin: 10px">FORMULARIO DE MODIFICACIÓN DE ADORACIÓN EN FAMILIA</h2>
            </form>
          </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <div id="form_ep" class="container">
        ...
        <div class="form-group">
          <a href="/stp/constantino/sistema/aef/reinicio.php"><input type="submit" class="btn btn-danger" id="eliminar" name="eliminar" value="SI, REINICIALO"></a>
        </div><br>
