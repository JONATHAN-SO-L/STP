...
<?php
  ...
  include "../../funciones/conexion.php";
    ...
    $resultado = mysqli_query($conexion,"SELECT EXISTS (SELECT * FROM noviembre_c);");
    $row=mysqli_fetch_row($resultado);

      if ($row[0]=="1") {

        $resultado = mysqli_query($conexion, "SELECT * FROM noviembre_c");
        ...
        <br><br>
          <div class='container'>
            ...
            <div class='form-group'>
              <center>
              <a href='/stp/constantino/sistema/im/mod11.php' class='btn active btn-warning' style='color:white;'>MODIFICAR INFORME</a>
              </center>
            </div>
          </div>
...
<br>';
  ...
  if (isset($_POST['guardar'])) {
    ...
    $conexion->query("INSERT INTO noviembre_c (publicaciones, videos, horas, revisitas, cursos, comentarios) VALUES ('$pubs', '$videos', '$hours', '$revisit', '$courses', '$comments')");
