...
if (isset($_SESSION['usuario'])) {
  switch ($_SESSION['usuario']) {
    ...
    $conexion->query("TRUNCATE TABLE enero_c");
    $conexion->query("TRUNCATE TABLE febrero_c");
    $conexion->query("TRUNCATE TABLE marzo_c");
    $conexion->query("TRUNCATE TABLE abril_c");
    $conexion->query("TRUNCATE TABLE mayo_c");
    $conexion->query("TRUNCATE TABLE junio_c");
    $conexion->query("TRUNCATE TABLE julio_c");
    $conexion->query("TRUNCATE TABLE agosto_c");
    $conexion->query("TRUNCATE TABLE septiembre_c");
    $conexion->query("TRUNCATE TABLE octubre_c");
    $conexion->query("TRUNCATE TABLE noviembre_c");
    $conexion->query("TRUNCATE TABLE diciembre_c");
