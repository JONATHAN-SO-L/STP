...
<?php
  ...
  include "../../funciones/conexion.php";
    ...
    $resultado = mysqli_query($conexion,"SELECT EXISTS (SELECT * FROM octubre_l);");
    $row=mysqli_fetch_row($resultado);

      if ($row[0]=="1") {

        $resultado = mysqli_query($conexion, "SELECT * FROM octubre_l");
        ...
        <br><br>
          <div class='container'>
            ...
            <div class='form-group'>
              <center>
              <a href='/stp/lily/sistema/im/mod10.php' class='btn active btn-warning' style='color:white;'>MODIFICAR INFORME</a>
              </center>
            </div>
          </div>
...
<br>';
  ...
  if (isset($_POST['guardar'])) {
    ...
    $conexion->query("INSERT INTO octubre_l (publicaciones, videos, horas, revisitas, cursos, comentarios) VALUES ('$pubs', '$videos', '$hours', '$revisit', '$courses', '$comments')");
