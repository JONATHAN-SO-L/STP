...
<?php
  ...
  include "../../funciones/conexion.php";
    ...
    $conexion->query("TRUNCATE TABLE enero_l");
    $conexion->query("TRUNCATE TABLE febrero_l");
    $conexion->query("TRUNCATE TABLE marzo_l");
    $conexion->query("TRUNCATE TABLE abril_l");
    $conexion->query("TRUNCATE TABLE mayo_l");
    $conexion->query("TRUNCATE TABLE junio_l");
    $conexion->query("TRUNCATE TABLE julio_l");
    $conexion->query("TRUNCATE TABLE agosto_l");
    $conexion->query("TRUNCATE TABLE septiembre_l");
    $conexion->query("TRUNCATE TABLE octubre_l");
    $conexion->query("TRUNCATE TABLE noviembre_l");
    $conexion->query("TRUNCATE TABLE diciembre_l");
