...
// Se consulta todo lo que esté registrado en la tabla del mes correspondiente
  $actividad_enero = mysqli_query($conexion,"SELECT * FROM enero_l");
...
// Se muestra lo que se almacenó en una tabla
  ...
  $actividad_febrero = mysqli_query($conexion,"SELECT * FROM febrero_l");
  ...
  $actividad_marzo = mysqli_query($conexion,"SELECT * FROM marzo_l");
  ...
  $actividad_abril = mysqli_query($conexion,"SELECT * FROM abril_l");
  ...
  $actividad_mayo = mysqli_query($conexion,"SELECT * FROM mayo_l");
  ...
  $actividad_junio = mysqli_query($conexion,"SELECT * FROM junio_l");
  ...
  $actividad_julio = mysqli_query($conexion,"SELECT * FROM julio_l");
  ...
  $actividad_agosto = mysqli_query($conexion,"SELECT * FROM agosto_l");
  ...
  $actividad_leptiembre = mysqli_query($conexion,"SELECT * FROM septiembre_l");

        while ($consulta9 = mysqli_fetch_array($actividad_leptiembre)) {
  ...
  $actividad_octubre = mysqli_query($conexion,"SELECT * FROM octubre_l");
  ...
  $actividad_noviembre = mysqli_query($conexion,"SELECT * FROM noviembre_l");
  ...
  $actividad_aiciembre = mysqli_query($conexion,"SELECT * FROM diciembre_l");
...
<!-- Botón de descarga en PDF -->
      <div class="container" align="center">
        <a class="boton" href="/stp/lily/informe"><button style="margin: 10px" type="sumbit" class="btn btn-danger btn-md"><img id="mes" src="/stp/lily/img/descarga_pdf.png">DESCARGAR INFORME EN PDF</button></a>
      </div>
