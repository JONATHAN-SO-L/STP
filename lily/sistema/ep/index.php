...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/stp/lily/css/ep_botones.css">
</head>
...
<body>
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    ...
    <form class="form-inline float-lg-right" id="volver"> <!-- Alineación a la derecha -->
      <a href="/stp/lily/sistema/" class="btn btn-danger btn-sm">VOLVER</a> <!-- Enlace de clase botón -->
...
// Tabla que muestra lo que está almacenado en la DDBB
      ...
      <button name="reiniciar" style="margin: 10px" type="sumbit" class="btn btn-primary btn-danger btn-lg" data-toggle="modal" data-target="#miModal3"><img id="ren" src="/stp/lily/img/reiniciar.png">REINICIAR PLAN DE ESTUDIO</button></div>';}
           ...
           <div id="form_ep" class="container">
            ...
            <div class="container">
              ...
              <form class="form-inline">
                <img id="ep-index" src="/stp/lily/img/ep.png" style="margin-top: 10px" ><h2 class="form-title" style="margin: 10px">FORMULARIO DE INICIO DEL ESTUDIO PERSONAL</h2>
              </form>
            </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <div id="form_ep" class="container">
          ...
          <div class="container">
            <form class="form-inline">
              <img id="ep-index" src="/stp/lily/img/ep.png" style="margin-top: 10px" ><h2 class="form-title" style="margin: 10px">FORMULARIO DE MODIFICACIÓN DEL ESTUDIO PERSONAL</h2>
            </form>
          </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <div id="form_ep" class="container">
        ...
        <div class="form-group">
          <a href="/stp/lily/sistema/ep/reinicio.php"><input type="submit" class="btn btn-danger" id="eliminar" name="eliminar" value="SI, REINICIALO"></a>
        </div><br>
