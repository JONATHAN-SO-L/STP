...
// Se consulta todo lo que esté registrado en la tabla del mes correspondiente
  $actividad_enero = mysqli_query($conexion,"SELECT * FROM enero_d");
...
// Se muestra lo que se almacenó en una tabla
  ...
  $actividad_febrero = mysqli_query($conexion,"SELECT * FROM febrero_d");
  ...
  $actividad_marzo = mysqli_query($conexion,"SELECT * FROM marzo_d");
  ...
  $actividad_abril = mysqli_query($conexion,"SELECT * FROM abril_d");
  ...
  $actividad_mayo = mysqli_query($conexion,"SELECT * FROM mayo_d");
  ...
  $actividad_junio = mysqli_query($conexion,"SELECT * FROM junio_d");
  ...
  $actividad_julio = mysqli_query($conexion,"SELECT * FROM julio_d");
  ...
  $actividad_agosto = mysqli_query($conexion,"SELECT * FROM agosto_d");
  ...
  $actividad_septiembre = mysqli_query($conexion,"SELECT * FROM septiembre_d");
  ...
  $actividad_octubre = mysqli_query($conexion,"SELECT * FROM octubre_d");
  ...
  $actividad_noviembre = mysqli_query($conexion,"SELECT * FROM noviembre_d");
  ...
  $actividad_diciembre = mysqli_query($conexion,"SELECT * FROM diciembre_d");
...
<!-- Botón de descarga en PDF -->
      <div class="container" align="center">
        <a class="boton" href="/stp/diego/informe"><button style="margin: 10px" type="sumbit" class="btn btn-danger btn-md"><img id="mes" src="/stp/diego/img/descarga_pdf.png">DESCARGAR INFORME EN PDF</button></a>
      </div>
