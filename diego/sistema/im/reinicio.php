...
<?php
  ...
  include "../../funciones/conexion.php";
    ...
    $conexion->query("TRUNCATE TABLE enero_d");
    $conexion->query("TRUNCATE TABLE febrero_d");
    $conexion->query("TRUNCATE TABLE marzo_d");
    $conexion->query("TRUNCATE TABLE abril_d");
    $conexion->query("TRUNCATE TABLE mayo_d");
    $conexion->query("TRUNCATE TABLE junio_d");
    $conexion->query("TRUNCATE TABLE julio_d");
    $conexion->query("TRUNCATE TABLE agosto_d");
    $conexion->query("TRUNCATE TABLE septiembre_d");
    $conexion->query("TRUNCATE TABLE octubre_d");
    $conexion->query("TRUNCATE TABLE noviembre_d");
    $conexion->query("TRUNCATE TABLE diciembre_d");
