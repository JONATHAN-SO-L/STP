...
<head>	<!-- Cabeza de la aplicación web -->
	...
	<link rel="icon" href="/stp/diego/img/favicon.ico" type="image/icon">	<!-- Ícono de la aplicación web -->
	...
	<link rel="stylesheet" type="text/css" href="/stp/diego/css/index.css">	<!-- Se enlaza nuestro archivo de diseño en CSS -->
</head>
...
<h2 style="color: white;"><strong><center>¡Bienvenido(a) Diego!</center></strong></h2>
...
<!-- Sección 1 -->
	<div class="container" align="center">
		<a class="boton" href="/stp/diego/sistema/ep"><button style="margin: 10px" type="sumbit" class="btn btn-primary active btn-lg"><img id="ep" src="/stp/diego/img/ep.png">ESTUDIO PERSONAL</button></a>	<!--Separación entre botones -->

		<a class="boton" href="/stp/diego/sistema/lb"><button style="margin: 10px" type="sumbit" class="btn btn-primary active btn-lg"><img id="lb" src="/stp/diego/img/lb.png">LECTURA DE LA BÍBLIA</button></a>

		<a class="boton" href="/stp/diego/sistema/ml"><button style="margin: 10px" type="sumbit" class="btn btn-primary active btn-lg"><img id="ml" src="/stp/diego/img/ml.png">META DE LIBROS</button></a>
	</div>

<!-- Sección 2 -->
	<div class="container" align="center">
		<a class="boton" href="/stp/diego/sistema/im"><button style="margin: 10px" type="sumbit" class="btn btn-primary active btn-lg"><img id="im" src="/stp/diego/img/im.png">INFORME MENSUAL</button></a>
    <a class="boton" href="/stp/diego/sistema/aef"><button style="margin: 10px" type="sumbit" class="btn btn-primary active btn-lg"><img id="aef" src="/stp/diego/img/aef.png">ADORACIÓN EN FAMILIA</button></a>
	</div>
</div>
<br>

<div class="container contenedor-modal" align="center">
	<span name="flotante" id="flotante" class="flotante" data-toggle="modal" data-target="#miModal" ><img class="qns2" src="/stp/diego/img/qns2.png" alt="Q&S"></span>
</div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="container">
          ...
          <div class="container">
            <form class="form-inline"><img id="qns" src="/stp/diego/img/qns2.png" style="margin-top: 5px" ><h2 class="form-title" style="margin: 10px">Quejas & Sugerencias</h2></form>

            <form method="POST" action="/stp/diego/funciones/q&s.php">
              <div>
                <br>
