...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <form class="form-inline float-lg-right" id="volver">
    <a href="/stp/jhonny/sistema/im" class="btn btn-danger btn-sm">VOLVER</a>
  </form>
...
<?php
  ...
  // Se verifica la existencia de registros en la DDBB
    $resultado = mysqli_query($conexion,"SELECT EXISTS (SELECT * FROM enero_j);");
    $row=mysqli_fetch_row($resultado);

      if ($row[0]=="1") {

        $resultado = mysqli_query($conexion, "SELECT * FROM enero_j");
      ...
      echo "
              <div class='container'> 
                ...
                <div class='form-group'>
                  <center>
                  <a href='/stp/jhonny/sistema/im/mod1.php' class='btn active btn-warning' style='color:white;'>MODIFICAR INFORME</a>
                  </center>
                </div>
              </div>
            <br><br>";}
...
// Se insertan los datos en la DDBB
        $conexion->query("INSERT INTO enero_j (publicaciones, videos, horas, revisitas, cursos, comentarios) VALUES ('$pubs', '$videos', '$hours', '$revisit', '$courses', '$comments')");
