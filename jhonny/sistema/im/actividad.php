...
// Se consulta todo lo que esté registrado en la tabla del mes correspondiente
  $actividad_enero = mysqli_query($conexion,"SELECT * FROM enero_j");
...
// Se muestra lo que se almacenó en una tabla
  ...
  $actividad_febrero = mysqli_query($conexion,"SELECT * FROM febrero_j");
  ...
  $actividad_marzo = mysqli_query($conexion,"SELECT * FROM marzo_j");
  ...
  $actividad_abril = mysqli_query($conexion,"SELECT * FROM abril_j");
  ...
  $actividad_mayo = mysqli_query($conexion,"SELECT * FROM mayo_j");
  ...
  $actividad_junio = mysqli_query($conexion,"SELECT * FROM junio_j");
  ...
  $actividad_julio = mysqli_query($conexion,"SELECT * FROM julio_j");
  ...
  $actividad_agosto = mysqli_query($conexion,"SELECT * FROM agosto_j");
  ...
  $actividad_septiembre = mysqli_query($conexion,"SELECT * FROM septiembre_j");
  ...
  $actividad_octubre = mysqli_query($conexion,"SELECT * FROM octubre_j");
  ...
  $actividad_noviembre = mysqli_query($conexion,"SELECT * FROM noviembre_j");
  ...
  $actividad_jiciembre = mysqli_query($conexion,"SELECT * FROM diciembre_j");

        while ($consulta12 = mysqli_fetch_array($actividad_jiciembre)) {
...
<!-- Botón de descarga en PDF -->
      <div class="container" align="center">
        <a class="boton" href="/stp/jhonny/informe"><button style="margin: 10px" type="sumbit" class="btn btn-danger btn-md"><img id="mes" src="/stp/jhonny/img/descarga_pdf.png">DESCARGAR INFORME EN PDF</button></a>
      </div>
