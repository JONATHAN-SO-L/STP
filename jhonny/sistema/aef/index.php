...
// Tabla que muestra lo que está almacenado en la DDBB
      ...
      <button name="reiniciar" style="margin: 10px" type="sumbit" class="btn btn-primary btn-danger btn-lg" data-toggle="modal" data-target="#miModal3"><img id="ren" src="/stp/jhonny/img/reiniciar.png">REINICIAR PLAN DE ESTUDIO</button></div>';}
           ...
           <div id="form_ep" class="container">
            ...
            <div class="container">
              ...
              <form class="form-inline">
                <img id="aef-index" src="/stp/jhonny/img/aef.png" style="margin-top: 10px" ><h2 class="form-title" style="margin: 10px">FORMULARIO DE INICIO DE ADORACIÓN EN FAMILIA</h2>
              </form>
            </div>
      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <div id="form_ep" class="container">
          ...
          <div class="container">
            <form class="form-inline">
              <img id="ep-index" src="/stp/jhonny/img/aef.png" style="margin-top: 10px" ><h2 class="form-title" style="margin: 10px">FORMULARIO DE MODIFICACIÓN DE ADORACIÓN EN FAMILIA</h2>
            </form>
          </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <div id="form_ep" class="container">
        ...
        <div class="form-group">
          <a href="/stp/jhonny/sistema/aef/reinicio.php"><input type="submit" class="btn btn-danger" id="eliminar" name="eliminar" value="SI, REINICIALO"></a>
        </div><br>
