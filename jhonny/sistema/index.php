...
<head>	<!-- Cabeza de la aplicación web -->
	...
	<link rel="stylesheet" type="text/css" href="/stp/jhonny/css/index.css">	<!-- Se enlaza nuestro archivo de diseño en CSS -->
</head>
...
<h2 style="color: white;"><strong><center>¡Bienvenido(a) Jonathán!</center></strong></h2>
...
<div class="container contenedor-modal" align="center">
	<span name="flotante" id="flotante" class="flotante" data-toggle="modal" data-target="#miModal" ><img class="qns2" src="/stp/jhonny/img/qns2.png" alt="Q&S"></span>
</div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="container">
          ...
          <div class="container">
            <form class="form-inline"><img id="qns" src="/stp/jhonny/img/qns2.png" style="margin-top: 5px" ><h2 class="form-title" style="margin: 10px">Quejas & Sugerencias</h2></form>

            <form method="POST" action="/stp/jhonny/funciones/q&s.php">
              <div>
                <br>
